...
public:
	...
	/**Schreiben  des  privaten  Attributes name eines  einzelnen  Objekts  vom  Typ SchaltwerkElement.*/
	void setName( string n);

	/**Schreiben  des  privaten  Attributes nachfolger eines  einzelnen  Objekts  vom  Typ SchaltwerkElement.*/
	void nachfolgerHinzufuegen( SchaltwerkElement *schaltwerkElement, int pos);

	/**Schreiben  des  privaten  Attributes anzahlNachfolger eines  einzelnen  Objekts  vom  Typ SchaltwerkElement.*/
	void setAnzahlNachfolger( int anzahlN);

	/**Schreiben  des  privaten  Attributes anzahlEingangssignale eines  einzelnen  Objekts  vom  Typ SchaltwerkElement.*/
	void setAnzahlEingangssignale( short anzahlE);

	/**Schreiben  des  privaten  Attributes isEingangsElement eines  einzelnen  Objekts  vom  Typ SchaltwerkElement.*/
	void setIsEingangsElement(bool isEingangsEl);

	/**Schreiben  des  privaten  Attributes isAusgangsElement eines  einzelnen  Objekts  vom  Typ SchaltwerkElement.*/
	void setIsAusgangsElement(bool isAusgangsEl);

	/**Schreiben  des  privaten  Attributes laufzeitEinzelgatter eines  einzelnen  Objekts  vom  Typ SchaltwerkElement.*/
	void setLaufzeitEinzelgatter(double lzt);
