...
\begin{titlepage}
	\begin{flushleft}
		...
		\end{picture}
			\put(140,14){\Large Karlsruher Institut fÃ¼r Technologie}
			\put(120,0){\large Institut fÃ¼r Technik der Informationsverarbeitung}
		\begin{picture}(0,0)
	...
	KIT - UniversitÃ¤t des Landes Baden WÃ¼rttemberg und nationales Forschungszentrum in der Helmholtz-Gemeinschaft
	\end{flushleft}
\end{titlepage}
%----------------------------
\tableofcontents
